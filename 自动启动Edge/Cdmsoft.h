...
public:
	...
	{
		long result;
		InvokeHelper(0x17a, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	long ReleaseRef()
	{
	...
	{
		long result;
		InvokeHelper(0x17d, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	...
	{
		long result;
		InvokeHelper(0x184, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
